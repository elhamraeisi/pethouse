...
try {
  ...
  if (!isset($_GET['id']) && empty($_GET['id'])) {
    ...
    $sql = 'INSERT INTO proprietaire(prenom, nom, sexe, ddn, adresse, tel, mail, photo) VALUES(:prenom, :nom, :sexe, :ddn, :adresse, :tel, :mail, :photo)';
  } else {
    // Si id n'est pas vide alors INSERT
    $sql = 'UPDATE proprietaire SET prenom=:prenom, nom=:nom, sexe=:sexe, ddn=:ddn, adresse=:adresse, tel=:tel, mail=:mail, photo=:photo WHERE id=' . $_GET['id'];
  }
